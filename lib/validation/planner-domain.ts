...
export function isTryoutRecord(value: unknown): value is TryoutRecord {
  ...
  return isNonEmptyString(record.id)
    ...
    && (record.gymSeasonId === undefined || record.gymSeasonId === null || typeof record.gymSeasonId === "string")
    && (record.gymSeasonNumber === undefined || record.gymSeasonNumber === null || typeof record.gymSeasonNumber === "number")
    && (record.gymSeasonLabel === undefined || record.gymSeasonLabel === null || typeof record.gymSeasonLabel === "string")
    && (record.gymSeasonAutoCreated === undefined || typeof record.gymSeasonAutoCreated === "boolean")
